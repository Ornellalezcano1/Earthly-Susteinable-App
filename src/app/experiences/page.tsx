...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50 px-[30px] py-6 flex justify-between items-center">
      ...
      {/* CENTER: Main navigation menu with glassmorphism style */}
...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ experience, isFavorite, onToggleFavorite }) => {
  ...
  return (
    <div className="group relative flex flex-col bg-white/[0.03] rounded-[40px] border border-white/10 overflow-hidden transition-all duration-500 hover:bg-white/[0.07] hover:-translate-y-2 shadow-2xl shadow-black/40">
      <div className="relative w-full h-72 overflow-hidden">
        ...
        >
          <Heart 
            size={18} 
            className={`transition-colors duration-300 ${isFavorite ? 'text-red-500 fill-red-500' : 'text-white/70'}`} 
          />
        </button>
...
const experienceData: Experience[] = [
  { 
    id: 1, 
    name: 'Peak Ascent Expedition', 
    location: 'Swiss Alps', 
    category: 'Adventure', 
    image: '/Experience_1.png', 
    description: 'Conquer the vertical world. A high-altitude journey through snow-covered ridges and breathtaking technical ascents designed for the bold.', 
    duration: '8 Hours',
    included: ['Alpine Ascension Kit', 'Certified Mountain Guide', 'Summit Nutrition']
  },
  { 
    id: 2, 
    name: 'Mindful Stillness Retreat', 
    location: 'Lofoten, Norway', 
    category: 'Relax', 
    image: '/Experience_2.png', 
    description: 'Find your center in total solitude. A sensory recovery experience designed to synchronize your natural rhythm with the whispers of the arctic.', 
    duration: 'Full Day',
    included: ['Guided Silent Walk', 'Private Mineral Bath', 'Organic Herbal Lab']
  },
  { 
    id: 3, 
    name: 'Ancient Craft Workshop', 
    location: 'Kyoto, Japan', 
    category: 'Culture', 
    image: '/Experience_3.jpg', 
    description: 'Master the delicate arts of a vanished era. A deep immersion into traditional craftsmanship guided by hereditary masters in sacred workshops.', 
    duration: '4 Hours',
    included: ['Heritage Toolkit', 'Master artisan session', 'Cultural Certification']
  },
  { 
    id: 4, 
    name: 'Wildlife Genesis Project', 
    location: 'Amazon Basin', 
    category: 'Volunteering', 
    image: '/Experience_4.jpg', 
    description: 'Stand at the frontlines of nature. Contribute to vital biological tracking and habitat restoration within the worlds most biodiverse canopy.', 
    duration: '5 Days',
    included: ['Conservation Training', 'Eco-lodging access', 'Field Tracking Gear']
  },
  { 
    id: 5, 
    name: 'Arctic Spa Haven', 
    location: 'Iceland', 
    category: 'Relax', 
    image: '/Experience_5.jpg', 
    description: 'Surrender to the warmth of natural hot springs under the northern sky. Total immersion in mineral-rich geothermal waters.', 
    duration: 'Full Day',
    included: ['VIP Lagoon Access', 'Towel & Skincare Kit', 'Healthy Lunch']
  },
  { 
    id: 6, 
    name: 'Temple Mindfulness', 
    location: 'Nepal', 
    category: 'Culture', 
    image: '/Experience_6.jpg', 
    description: 'Spiritual connection guided by local monks in ancient high-altitude shrines. Find inner peace above the clouds.', 
    duration: '3 Hours',
    included: ['Monk Guidance', 'Private Shrine Access', 'Meditation Mat']
  },
  { 
    id: 7, 
    ...
    location: 'Bali', 
    category: 'Relax', 
    image: '/Experience_7.jpg', 
    description: 'Sunrise Vinyasa session on a private beach focused on deep connection between breath and the rhythm of the waves.', 
    duration: '90 Mins',
    included: ['Expert Instructor', 'Organic Juice Bar', 'Aromatherapy']
  },
  { 
    id: 8, 
    ...
    location: 'Australia', 
    category: 'Volunteering', 
    image: '/Experience_8.jpg', 
    description: 'Diving to help rebuild the vital ecosystems of the Great Barrier Reef alongside marine biologists.', 
    duration: '5 Days',
    included: ['Diving Certificate', 'Lab Training', 'Project Reports']
  },
];
  ...
  return (
    <main className="relative w-full h-screen bg-[#050609] font-sans text-white overflow-x-hidden overflow-y-auto 
      ...
      <div className="relative z-10 flex flex-col w-full min-h-full pb-[60px]">
        ...
        {/* Title Section */}
        <div className="px-[30px] pt-32 pb-8">
          <h1 className="text-4xl md:text-6xl font-medium tracking-tight mb-6 animate-in slide-in-from-left duration-700">
            Our Experience
          </h1>
          <p className="text-white/60 text-lg max-w-2xl font-light leading-relaxed min-h-[80px] transition-all duration-500 animate-in fade-in">
            {categoryDescriptions[selectedCategory]}
          </p>
        </div>

        {/* Filter Bar */}
        <div className="px-[30px] mb-12 flex flex-wrap gap-3">
          {categories.map((cat) => (
            <button 
              key={cat}
        ...
        {filteredExperience.length === 0 && (
          <div className="px-[30px] py-20 text-center">
            <p className="text-white/30 text-xl font-light tracking-tight uppercase italic">No experience found in this category.</p>
          </div>
        )}
      </div>
    </main>
